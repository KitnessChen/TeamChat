                ...
                <li class="dropdown all-camera-dropdown">
                    <a class="dropdown-toggle username" data-toggle="dropdown" href="#">
                        <img class="img-circle"
                             ...
                             alt="Generic placeholder image" style="width: 30px; height: 30px;">
                        <% username %>
                        <b class="caret"></b>
                    </a>
                    <ul class="dropdown-menu">
                        <li><a data-toggle="tab" href="/profile"><span class="glyphicon glyphicon-user"> Profile</span></a>
                        </li>
                        <li><a data-toggle="tab" href="/settings"><span class="glyphicon glyphicon-cog"> Settings</span></a>
                        </li>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="create-team-form" action method="post" class="auth-form form-horizontal">
                    <div class="inputbox">
                        <input type="text" class="form-control" placeholder="Team Name" id="teamname" required
                               autofocus>
                    </div>
                    <div class="inputbox">
...
<div class="modal fade" id="SearchTeamModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
